...
<style>
    ...
    .ex-menu-btn { min-height: 40px; padding:0 13px; border: 1px solid var(--line); border-radius: 10px; background: #fff; color: var(--ink); font-size:12px; font-weight:800; }
    ...
    .ex-nav a:hover, .ex-nav button:hover { background: var(--bg); border-color: var(--line); }
    ...
    .metric-strip { display: grid; grid-template-columns: repeat(2,minmax(0,1fr)); border-block: 1px solid #e0e4dc; background: rgba(239,247,241,.46); }
    ...
    .metric-strip b { display: block; margin-top: 5px; color: #17201b; font-size: 22px; line-height: 1.2; overflow-wrap: break-word; word-break:normal; }
    .ex-table-wrap { overflow-x: auto; border-block: 1px solid #e0e4dc; background: rgba(255,255,255,.45); }
    ...
    .ex-record { border-bottom: 1px solid #e0e4dc; padding: 14px 4px; }
    ...
    .ex-action { display: inline-flex; align-items: center; justify-content: center; min-height: 38px; padding: 0 13px; border-radius: 9px; border: 1px solid #17201b; background: #17201b; color: #fff; text-decoration: none; font-weight: 900; font-size: 13px; transition: transform .16s ease, background .16s ease; }
    .ex-action:hover { transform: translateY(-1px); color: #fff; }
    ...
    .ex-badge.APPROVED, .ex-badge.active { color: var(--emerald); background: rgba(85,117,101,.1); }
    .ex-badge.REJECTED { color: var(--red); background: rgba(138,91,91,.1); }
    .ex-badge.DUPLICATE, .ex-badge.USED { color: var(--amber); background: rgba(138,117,85,.1); }
    .ex-empty { border-left:3px solid var(--line-2); background: rgba(95,112,130,.04); color: var(--ink-3); padding: 16px; line-height: 1.6; }
    ...
    @media (max-width: 640px) {
        ...
        .ex-table-wrap.mobile-list tr { border: 0; border-left: 3px solid rgba(100,117,106,.55); border-bottom: 1px solid #e0e4dc; background: rgba(239,247,241,.3); padding: 12px 14px; margin-bottom: 4px; }
