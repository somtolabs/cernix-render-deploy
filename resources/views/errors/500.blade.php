...
<head>
    ...
    <title>500 — {{ $brandingSystemName ?? 'System' }}</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .divider { width: 36px; height: 3px; background: var(--red); border-radius: 2px; margin: 20px auto; opacity: .45; }
...
<body>
    <div class="shell">
        ...
        <p class="desc">Something went wrong on our end. The issue has been logged. Please try again in a moment or contact the system administrator.</p>
        <div class="actions">
