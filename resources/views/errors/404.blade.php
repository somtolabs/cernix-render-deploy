...
<head>
    ...
    <title>404 — {{ $brandingSystemName ?? 'System' }}</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .divider { width: 36px; height: 3px; background: var(--line); border-radius: 2px; margin: 20px auto; }
...
<body>
    <div class="shell">
        ...
        <p class="desc">The page you're looking for doesn't exist or has been moved. Check the URL and try again.</p>
        <div class="actions">
